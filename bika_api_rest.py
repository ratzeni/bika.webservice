...
class BikaApiRestService(object):
    ...
    def get_analysis_requests(self):
        ...
        result = [dict(
                ...
                review_state=str(r['review_state']) if 'published' in str(r['review_state']) else str(r['subject'][0]),
                #review_state=str(r['subject'][0]) if 'publishstr(r['review_state']) else str(r['review_state']),
